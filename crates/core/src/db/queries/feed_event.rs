...
use crate::{
    db::{
        any, models,
        pg::Pg,
        tables::{feed_event_wallets, feed_events, graph_connections, mint_events},
        Connection,
    },
    error::prelude::*,
};
...
pub fn list<W: Clone + AsExpression<Text>>(
    ...
    limit: i64,
    offset: i64,
) -> Result<Vec<(models::FeedEvent, Option<models::MintEvent>)>>
where
        ...
        >,
{
    ...
    let rows: Vec<(models::FeedEvent, Option<models::MintEvent>)> = feed_event_wallets::table
