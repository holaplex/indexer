...
pub struct DolphinStats<'a> {
    ...
    #[sql_type = "Numeric"]
    pub listed_1d: BigDecimal,
    #[sql_type = "Numeric"]
    pub listed_7d: BigDecimal,
    #[sql_type = "Numeric"]
    pub listed_30d: BigDecimal,
    #[sql_type = "Numeric"]
    ...
    #[sql_type = "Numeric"]
    pub last_listed_1d: BigDecimal,
    #[sql_type = "Numeric"]
    pub last_listed_7d: BigDecimal,
    #[sql_type = "Numeric"]
    pub last_listed_30d: BigDecimal,
    #[sql_type = "Numeric"]
