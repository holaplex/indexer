...
use indexer_core::{
    db::{
        insert_into,
        models::{AuctionData, AuctionDataExt, Bid},
        select,
        tables::{auction_datas, auction_datas_ext, bids},
        Connection,
    },
    prelude::*,
...
use metaplex_auction::processor::{
    AuctionData as AuctionDataAccount, AuctionDataExtended, BidState, BidderMetadata, PriceFloor,
...
async fn process_auction_data(
    ...
    let values = AuctionData {
        ...
        // gap_tick_size: todo!(), // ext.gap_tick_size_percentage.map(Into::into),
        // instant_sale_price: todo!(), [> ext
        //                          *     .instant_sale_price
