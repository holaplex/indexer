use indexer_core::{
    ...
    db::{
        ...
        sql_types::Text,
        tables::{
            attributes, auction_houses, bid_receipts, collection_mints, current_metadata_owners,
            listing_receipts, listings, metadata_collection_keys, metadata_jsons, metadatas,
        },
    },
    pubkeys,
    url::Url,
...
impl<'a> TryFrom<models::Collection<'a>> for Coll {
    type Error = std::num::TryFromIntError;
