...
use objects::{
    ...
    collection::{Collection, CollectionTrend},
...
pub struct AppContext {
    ...
    pub mr_collection_holders_count_loader:
        Loader<objects::collection::CollectionId, Option<CollectionHoldersCount>>,
    pub mr_collection_trends_loader: Loader<String, Option<CollectionTrend>>,
    ...
    pub nft_collection_loader: Loader<PublicKey<TokenMint>, Option<Collection>>,
...
impl AppContext {
    pub(crate) fn new(shared: Arc<SharedData>) -> AppContext {
        ...
        Self {
            ...
            mr_collection_holders_count_loader: Loader::new(batcher.clone()),
            mr_collection_trends_loader: Loader::new(batcher.clone()),
