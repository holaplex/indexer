...
use objects::{
    ...
    nft::{
        CollectionNFT, CollectionTrend, Nft, NftActivity, NftAttribute, NftCreator, NftFile,
        NftOwner,
    },
...
pub struct AppContext {
    ...
    pub mr_collection_trends_loader: Loader<CollectionId, Option<CollectionTrend>>,
...
impl AppContext {
    pub(crate) fn new(shared: Arc<SharedData>) -> AppContext {
        ...
        Self {
            ...
            mr_collection_nft_count_loader: Loader::new(batcher.clone()),
