...
pub struct AppContext {
    ...
    pub ah_listings_loader: Loader<PublicKey<BaseNft>, Vec<AhListing>>,
    ...
    pub bid_receipts_loader: Loader<PublicKey<BaseNft>, Vec<BidReceipt>>,
    pub collection_count_loader: Loader<PublicKey<StoreCreator>, Option<i32>>,
    pub collection_loader: Loader<PublicKey<StoreCreator>, Vec<BaseNft>>,
    ...
    pub listing_nfts_loader: Loader<PublicKey<Listing>, Vec<(usize, BaseNft)>>,
    pub listing_receipt_loader: Loader<PublicKey<ListingReceipt>, Option<ListingReceipt>>,
    pub listing_receipts_loader: Loader<PublicKey<BaseNft>, Vec<ListingReceipt>>,
    ...
    pub nft_activities_loader: Loader<PublicKey<BaseNft>, Vec<NftActivity>>,
    pub nft_attributes_loader: Loader<PublicKey<BaseNft>, Vec<NftAttribute>>,
    pub nft_collection_loader: Loader<PublicKey<BaseNft>, Option<CollectionNft>>,
    pub nft_creators_loader: Loader<PublicKey<BaseNft>, Vec<NftCreator>>,
    pub nft_files_loader: Loader<PublicKey<BaseNft>, Vec<NftFile>>,
    pub nft_loader: Loader<PublicKey<BaseNft>, Option<BaseNft>>,
    pub nft_owner_loader: Loader<PublicKey<BaseNft>, Option<NftOwner>>,
    pub offer_loader: Loader<Uuid, Option<AhOffer>>,
    pub offers_loader: Loader<PublicKey<BaseNft>, Vec<AhOffer>>,
    ...
    pub purchase_receipts_loader: Loader<PublicKey<BaseNft>, Vec<PurchaseReceipt>>,
    pub purchases_loader: Loader<PublicKey<BaseNft>, Vec<AhPurchase>>,
